...
class SegformerConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        long_decoder_depth=0, ### /!\ added code by student
        width_list = [], ### /!\ added code by student
        **kwargs,
    ):
        ...
        self.long_decoder_depth = long_decoder_depth ### /!\ added code by student
        self.width_list = width_list ### /!\ added code by student
